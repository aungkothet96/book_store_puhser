    ...
    <div class="row mt-2 mb-2 justify-content-center" >
        <div class="col-md-auto">
            ...
            <div class="form-inline row justify-content-center">
                ...
                <button type="button" class="btn ii-search-btn mb-2 ml-2" @click.prevent="postGenre">Save</button>
            </div>
            @else
            <form action="{{URL::to('admin/genre/update/'.$genre['id'])}}" class="form-inline row justify-content-center" method="post">
                {{ csrf_field() }}
                 <div class="form-group mb-2 ml-2">
                    <label for="staticEmail2" >Name</label>
                </div>
